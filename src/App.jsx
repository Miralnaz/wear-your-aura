  ...
  return (
    <div style={{ backgroundColor: '#fff', color: '#111', minHeight: '100vh', fontFamily: 'serif' }}>
      ...
      <div style={{ position: 'fixed', right: '20px', bottom: '20px', display: 'flex', flexDirection: 'column', gap: '10px', zIndex: 1000 }}>
        <a href="https://wa.me/923132607073" target="_blank" rel="noreferrer" style={{ backgroundColor: '#25D366', color: 'white', padding: '15px', borderRadius: '50px', textDecoration: 'none', textAlign: 'center', fontWeight: 'bold', boxShadow: '0 4px 10px rgba(0,0,0,0.3)' }}>WhatsApp Order</a>
        <a href="https://www.instagram.com/hn.fragrances" target="_blank" rel="noreferrer" style={{ backgroundColor: '#E1306C', color: 'white', padding: '15px', borderRadius: '50px', textDecoration: 'none', textAlign: 'center', fontWeight: 'bold', boxShadow: '0 4px 10px rgba(0,0,0,0.3)' }}>Instagram Page</a>
      </div>
      ...
      </div> {/* FIX: Yahan pehle </nav> tha jo error de raha tha */}
      ...
      <section id="collection" style={{ padding: '80px 20px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px' }}>
          {products.map(p => (
            <div key={p.id} style={{ border: '1px solid #f0f0f0', padding: '20px', textAlign: 'center' }}>
          ...
          <div style={{ backgroundColor: 'white', padding: '40px', borderRadius: '12px', maxWidth: '450px', width: '90%' }}>
            ...
            {paymentMethod === 'Online' && (
              <div style={{ backgroundColor: '#e8f5e9', padding: '15px', border: '1px dashed #2e7d32', margin: '15px 0' }}>
                ...
                <p style={{ fontSize: '0.8rem', color: '#d32f2f' }}>*Screenshot required for WhatsApp.</p>
              </div>
            )}
            <button onClick={() => {
            ...
            }} style={{ width: '100%', padding: '15px', backgroundColor: '#000', color: '#fff', border: 'none', fontWeight: 'bold', cursor: 'pointer' }}>CONFIRM VIA WHATSAPP</button>
      ...
      <footer style={{ padding: '40px', textAlign: 'center', borderTop: '1px solid #eee', color: '#999' }}>
